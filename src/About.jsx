function About() {
  return (
    <div className="bg-[#222831] py-36 min-[1130px]:py-0 grid place-content-center overflow-clip relative">
      <section className="relative min-[1130px]:h-dvh grid min-[1130px]:grid-cols-5 place-items-center max-w-[1800px]">
        ...
        <div className=" col-span-2 max-[472px]:px-12 px-28 max-[472px]:mb-12 mb-24 relative">
          ...
          <p className="max-[580px]:text-center max-[472px]:text-sm text-lg text-[#EEEEEEBF] line-clamp-7">
